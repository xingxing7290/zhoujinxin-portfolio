...
- 正式网站：<https://xstar.cc.cd/>
- English：<https://xstar.cc.cd/en>
- 内容后台：<https://xstar.cc.cd/admin>
- 健康检查：<https://xstar.cc.cd/api/health>
...
- Cloudflare Tunnel：通过出站连接提供正式域名入口，绕开机房对入站域名 Host/SNI 的拦截。
- Docker Compose：应用、Caddy 与 Cloudflared 三个轻量容器，数据、隧道凭据和证书独立持久化。
